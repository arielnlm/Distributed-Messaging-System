...
public class AppConfig {
	...
	public static Address bootstrapAddress;
	public static String WORKING_ROOT;
	public static int SOFT_FAILURE;
	public static int HARD_FAILURE;
	/**
	...
	public static void readConfig(String configName){
		...
		WORKING_ROOT = properties.getProperty("working_root", "working_root");
		SOFT_FAILURE = Integer.parseInt(properties.getProperty("soft_failure", "5000"));
		HARD_FAILURE = Integer.parseInt(properties.getProperty("hard_failure", "10000"));

		String bootstrapAddressString = properties.getProperty("bootstrap_address");
		bootstrapAddress = new Address(bootstrapAddressString.split(":")[0],
				Integer.parseInt(bootstrapAddressString.split(":")[1]));
		...
		for (int i = 0; i < serventCount; i++) {
			...
			ServentInfo newInfo = new ServentInfo("localhost", i, serventPort, neighborList, true);
