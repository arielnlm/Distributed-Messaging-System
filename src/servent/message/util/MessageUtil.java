...
public class MessageUtil {
	...
	public static Message readMessage(Socket socket) {
		...
		if (MESSAGE_UTIL_PRINTING) {
			if(clientMessage.getMessageType().equals(MessageType.PING) || clientMessage.getMessageType().equals(MessageType.PONG))
				AppConfig.timestampedErrorPrint("Got message " + clientMessage);
			else
